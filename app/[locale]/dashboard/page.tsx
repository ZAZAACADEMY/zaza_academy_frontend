...
export default function DashboardPage() {
  ...
  return (
    <div className="p-4 md:p-8 lg:p-12">
      ...
      <div className="relative overflow-hidden bg-linear-to-br from-[#25D366] to-[#128C7E] rounded-3xl md:rounded-4xl p-4 md:p-10 mb-6 md:mb-8 shadow-xl shadow-green-900/10 group">
        ...
        <div className="relative z-10 flex flex-row items-center justify-between gap-3 md:gap-8">
          <div className="flex items-center gap-3 md:gap-6">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center shrink-0 border border-white/30">
              <svg
                viewBox="0 0 24 24"
          ...
          <a
            ...
            className="bg-white text-[#128C7E] font-bold py-2 px-3 md:py-2.5 md:px-5 rounded-full flex items-center gap-2 text-sm hover:bg-gray-50 transition-all transform hover:scale-105 shadow-md shrink-0"
          >
            <svg
              viewBox="0 0 24 24"
